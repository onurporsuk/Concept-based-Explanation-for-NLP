...
class CustomAlbertClassificationHead(nn.Module):
    """
...
class CustomAlbertForSequenceClassification(AlbertPreTrainedModel):
    """
    ...
    def __init__(self, config):
        ...
        self.classifier = CustomAlbertClassificationHead(config)
